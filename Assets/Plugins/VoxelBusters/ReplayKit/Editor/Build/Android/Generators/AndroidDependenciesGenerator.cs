...
#region Constants
		...
		/// </summary>
		private		const	string kDependencyName 		        = "ReplayKitDependencies.xml";
...
#region Private static methods
        ...
        private static void Update()
		{
			...
			ReplayKitSettings.Instance.SettingsUpdated -= Create;
			ReplayKitSettings.Instance.SettingsUpdated += Create;
		...
		private static void CreateInternal(string path)
		{
            ...
            using (var xmlWriter = XmlWriter.Create(path, settings))
			{
				...
				{
                    xmlWriter.WriteComment("DONT MODIFY HERE. AUTO GENERATED DEPENDENCIES FROM ReplayKit's AndroidDependenciesGenerator.cs.");
